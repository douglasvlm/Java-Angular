package com.douglas.crud.meetingroom.controller;

import com.douglas.crud.meetingroom.exception.ResourceNotFoundException;
import com.douglas.crud.meetingroom.model.Room;
import com.douglas.crud.meetingroom.repository.RoomRepository;
...
public class RoomController {
    ...
    public Map<String, Boolean> deleteRoom(@PathVariable(value = "id") Long roomId)
        throws ResourceNotFoundException{
        Room room = roomRepository.findById(roomId)
                .orElseThrow(()-> new ResourceAccessException("Room not found this id : "+ roomId));
